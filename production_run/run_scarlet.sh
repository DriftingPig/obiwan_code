...
export PYTHONPATH=./galsim_modules:./py-scarlet:/usr/local/lib/python:/usr/local/lib/python3.6/dist-packages:/src/unwise_psf/py:.
...
# 128 GB / Cori Haswell node = 134217728 kbytes, 32 cores, 64 threads
maxmem=134217728
let usemem=${maxmem}*${threads}/64
...
export RANDOMS_FROM_FITS=${topdir}/${name_for_run}/divided_randoms/brick_${brick}.fits
