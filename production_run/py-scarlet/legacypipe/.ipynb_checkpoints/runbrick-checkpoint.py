...
def stage_image_coadds(survey=None, targetwcs=None, bands=None, tims=None,
    ...
    # obiwan, IDs of simulated galaxies touching ccds
...
def stage_fitblobs(T=None,
    ...
    if checkpoint_filename is None:
        ...
        #obiwan_scarlet
        #from fit_scarlet import scarlet_fiting
        #R_new = scarlet_fiting(blobmap,blobsrc,blobslice,tim)
...
def stage_coadds(survey=None, bands=None, version_header=None, targetwcs=None,
    ...
    #obiwan, Coadd of optical simulated galaxies
    if False and hasattr(tims[0], 'sims_image'):
    ...
    #obiwan: ask the code to not write coadds
    callback = None
    #callback = write_coadd_images
    #callback_args=(survey, brickname, version_header, tims,targetwcs, co_sky)
    callback_args=None
    ...
    if False and hasattr(tims[0], 'sims_image'):
        coadd_list.append(('simscoadd', sims_coadd, {}))
    #obiwan: skip writing jpeg to save time
    coadd_list=[]
...
def stage_wise_forced(
    ...
    **kwargs):
    ...
    #obiwan, reprocess_wcat
    if survey.no_sim is False:
        from legacypipe.unwise_sim import reprocess_wcat
        wcat,Nmorewcat = reprocess_wcat(wcat, brickname,kwargs['blobmap'],maskbits,T,survey)
    else:
        Nmorewcat=0
    #Nmorewcat=0
    #debug: write down list of objects 
    #from obiwan_debug import write_down_wcat
    #write_down_wcat(wcat)
        ...
        for band in [1,2]:
            ...
            for ie in range(Nepochs):
                ...
                eargs.append((ie,(wcat, eptiles, band, roiradec,
                                  wise_ceres, wpixpsf, False, None, ps, False, unwise_modelsky_dir,survey.simcat,targetwcs)))
    ...
    if len(phots):
        ...
        #obiwan: save time&space, ignore apflux
        unwise_coadds=False
        if unwise_coadds:
            ...
            api,apd,apr = apphot
            #obiwan: deleting 3,4
            for iband,band in enumerate([1,2]):
