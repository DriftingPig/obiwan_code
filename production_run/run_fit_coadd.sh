...
export PYTHONPATH=./galsim_modules:/global/cscratch1/sd/huikong/Obiwan/dr9_LRG/obiwan_code/obiwan_dr9m/dev-9.6.6/py-fit-coad:/usr/local/lib/python:/usr/local/lib/python3.6/dist-packages:/src/unwise_psf/py:.
