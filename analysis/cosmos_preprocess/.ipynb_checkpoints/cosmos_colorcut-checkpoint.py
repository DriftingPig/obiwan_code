...
class scatter_ratio(object):
    def __init__(self,target_type='elg_sv3_hip',cotamin = False,mode='normal'):
        self.mode = mode
...
def cosmos_colorcut():
    ...
    cls_sr = scatter_ratio(cotamin=False,target_type = cr.target_type,mode = 'normal')
    cls_sr_cotamin = scatter_ratio(cotamin=True, target_type = cr.target_type,mode='normal')
