    ...
    for brickname in bricknames:
        ...
        for i in range(len(sets)):
            ...
            for j in range(len(sets)):
                ...
                #maskbits
                maskbits = dat[j][sel_j]['maskbits'][idx1]
...
def stack_main_all():
    ...
    for fn in fns:
        ...
        dat.write(savedir+'cosmos_all_stacked/'+"new_cosmos_set%d.fits"%i,overwrite=True)
        i+=1
