...
if __name__ == "__main__":
    ...
    outdir = "/global/cfs/cdirs/desi/users/huikong/decals_ngc/"
    ...
    ##bricklist = np.loadtxt("/global/cscratch1/sd/huikong/Obiwan/dr9_LRG/obiwan_out/brickstat/real_brick_lists/bricks_deep1.txt",dtype = np.str)
    bricklist = np.loadtxt("/global/cfs/cdirs/desi/users/huikong/decals_ngc/meta/bricklist.txt",dtype=np.str)
    ...
    seeds = seed_maker(ndraws=ndraws,outdir=outdir, rotation=0., seed=seed, surveybricks = surveybricks, bricklist = ['2395p337'], grid_type=grid_type, seed_num = 41, region=region)
    seeds()
