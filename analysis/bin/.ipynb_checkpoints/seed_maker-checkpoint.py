...
class seed_maker(object):
    def __init__(self, ndraws=None, outdir=None, rotation=None, seed=None, surveybricks = None, bricklist = None, grid_type = None ,seed_num = None, rand_fn='divided_randoms', region = 'south'):
        self.bits = [1, 5, 6, 7, 8, 11, 12, 13]# BRIGHT, ALLMASK_G,R,Z, WISE, MEDIUM, GALAXY, CLUSTER
        self.ndraws = ndraws
        self.outdir = outdir
        self.rotation = 0.
        self.seed = seed
    ...
    def _grid_sampler(self,brickname):
        ...
        side = 300 # 60*0.262 = 15.72 arcsec
...
if __name__ == "__main__":
    ...
    outdir = "/global/cscratch1/sd/huikong/Obiwan/dr9_LRG/obiwan_out/sv3_lrg_north/"
    ...
    bricklist = np.loadtxt("/global/cscratch1/sd/huikong/Obiwan/dr9_LRG/obiwan_out/brickstat/real_brick_lists/bricks_sv3_lrg_north.txt",dtype = np.str)
    seeds = seed_maker(ndraws=ndraws,outdir=outdir, rotation=0., seed=seed, surveybricks = surveybricks, bricklist = bricklist, grid_type=grid_type, seed_num = 42, region=region)
    seeds()
