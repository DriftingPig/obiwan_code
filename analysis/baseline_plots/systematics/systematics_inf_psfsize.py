...
for band in ['g','r','z']:
    ...
    var = obiwan['psfsize_%s'%band][sel0]
    ratios2 = []
    ...
    for i in range(10):
        ...
        var = obiwan['psfsize_%s'%band][sel0][idx]
        ratios2 = []
        for k in range(0,8):
...
np.savetxt(savedir+'obiwan_g_psfsize.txt', obiwan_psf_g)
np.savetxt(savedir+'obiwan_r_psfsize.txt', obiwan_psf_r)
np.savetxt(savedir+'obiwan_z_psfsize.txt', obiwan_psf_z)
